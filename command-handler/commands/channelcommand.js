...
module.exports = {
    description: 'Specifies what commands can be run inside of what channels.',
    ...
    callback: async ({ instance, guild, interaction }) => {
        ...
        if (availableChannels.length) {
            ...
            return `The command "${commandName}" can now only be ran in the following channels: ${channelNames}`
        }
