        ...
        if (type === "SLASH" || type === "BOTH") {
          if (testOnly) {
            for (const guildId of this._instance.testServers) {
              ...
              //  console.log(`Guild server command: ${command.commandName} succesfully deleted.`)
            }
          } else {
            this._slashCommands.delete(command.commandName);
            // console.log(`Global command: ${command.commandName} succesfully deleted.`)
          }
        }
        continue;
      }
      ...
      if (type === "SLASH" || type === "BOTH") {
        ...
        if (testOnly) {
          for (const guildId of this._instance.testServers) {
            ...
            //   console.log(`Guild ${command.commandName} registered.`)
          }
        } else {
          this._slashCommands.create(command.commandName, description, options);
          //  console.log(`Global ${command.commandName} registered.`)
        }
      }
    }
  }
